    ...
    <section class="l-contents cf">
        <section class="l-main">
            <div class="registration">
                <h2 class="h">{{ HTML::image('home/assets/img/form/h_registration.png', '新規会員登録', ['width' => '750', 'height' => '95']) }}</h2>
                <div class="formbox">
                    {{ Form::open(['route' => 'auth.signup_complete']) }}
                        ...
                        <table class="apply-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    〒{{ Input::get('zip_code') }}{{ Form::hidden('zip_code', Input::get('zip_code')) }}<br>
