...
@section('content')
    ...
    <section class="l-contents cf">
        <section class="l-main">
            <h2>{{ HTML::image('home/assets/img/top/newjobinfo.png', '最新求人情報', ['width' => '750', 'height' => '95']) }}</h2>
            <br>
            @include('partials.html.search_box3')<!-- /.search-box -->
            <section class="pagenav">
                <p>全<strong>{{ $jobs->count() }}</strong>件（{{ 1 }}～{{ $jobs->count() }}件を表示）</p>
            </section>
