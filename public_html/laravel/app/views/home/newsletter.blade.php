        ...
        <section class="l-main">
            <div class="mailmagazine">
                ...
                @elseif(FormStrap::hasAlert(['success']))
                    <br>
                    <br>
                    {{ HTML::image('home/assets/img/mailmagazine/mailmagazine.png', 'メールマガジン登録完了', ['width' => '750', 'height' => '120']) }}
                @else
                ...
                <div class="formbox">
                    {{ Form::open(['route' => 'home.newsletter_confirm']) }}
                        <table class="apply-table">
                            ...
                            <tr>
                                ...
                                <td>▼希望エリア<br>
                                    {{ Form::select('prefecture_id', ['' => '都道府県を選択してください'] + JapanesePrefectures::prefectures(), '', ['class' => 'pref']) }}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="check">
                                        @foreach(NewsletterJobType::job_types() as $job_type_id => $job_type_name)
                                            {{ Form::checkbox('job_types[]', $job_type_id) }}{{ $job_type_name }}&nbsp;
                                        @endforeach
                                        <div class="text-danger">{{ $errors->first('job_types') }}</div>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <p class="btn"><input type="image" src="home/assets/img/form/btn_confirm_l.png" alt="利用規約の取り扱いに同意し、内容を確認する"></p>
                    {{ Form::close() }}
                </div>
                @endif
        </section><!-- /.l-main -->
