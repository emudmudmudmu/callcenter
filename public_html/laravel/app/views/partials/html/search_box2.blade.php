		<section class="search-box">
			<article class="tab-box" id="tabs">
				...
				<div id="area">
					<p class="map">{{ HTML::image('home/assets/img/top/areasearch_main_bg.jpg', '地域から探す　コールセンターお仕事検索', ['width' => '750', 'height' => '360']) }}</p>
							...
							<tr>
								...
								<td>
									...
									@foreach(JobType::job_types() as $type_id => $type_name)
										<nobr>{{ Form::checkbox('type_ids[]', $type_id) }}{{ $type_name }}</nobr>
									@endforeach
									</div>
								</td>
							</tr>
