              ...
              <div class="row">
                ...
                <table class="job-entry-table">
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::text('title', $job->title, ['class' => 'form-control input-text-l']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::text('catch_phrase', $job->catch_phrase, ['class' => 'form-control input-text-l']) }}
                    ...
                    <tr>
                        ...
                        <td>
                            {{ Form::textarea('catch_text', $job->catch_text, ['class' => 'form-control', 'rows' => '5']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('description', $job->description, ['class' => 'form-control', 'rows' => '5']) }}
                        ...
                        <td>
                        	@foreach(JobType::job_types() as $type_id => $type_name)
	                            <label class="checkbox-inline">
	                              {{ Form::checkbox('job_type_ids[]', $type_id, (!empty($job_metas['type_ids']) && in_array($type_id, $job_metas['type_ids']))) }} {{ $type_name }}
	                            </label>
                        	@endforeach
                    ...
                    <tr>
                        ...
                        <td>
                        	...
                        	@foreach(JobCategory::job_categories() as $category_id => $category_name)
	                            <label class="checkbox-inline">
	                              {{ Form::checkbox('job_category_ids[]', $category_id, (!empty($job_metas['category_ids']) && in_array($category_id, $job_metas['category_ids']))) }} {{ $category_name }}
	                            </label>
                        	@endforeach
                    ...
                    <tr>
                        ...
                        <td>
                        	@foreach(JobCondition::job_conditions() as $condition_id => $condition_name)
	                            <label class="checkbox-inline">
	                              {{ Form::checkbox('job_condition_ids[]', $condition_id, (!empty($job_metas['condition_ids']) && in_array($condition_id, $job_metas['condition_ids']))) }} {{ $condition_name }}
	                            </label>
                        	@endforeach
...
<!--
                    <tr>
                        ...
                        <td>
                        	{{ Form::text('job_pattern', $job->job_pattern, ['class' => 'form-control input-text-l']) }}
...
-->
                    ...
                    <tr>
                        ...
                        <td>
                            {{ Form::text('other_address2', $job->other_address2, ['class' => 'form-control input-text-l']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('transportation', $job->transportation, ['class' => 'form-control', 'rows' => '3']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('duty_hours', $job->duty_hours, ['class' => 'form-control', 'rows' => '3']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('salary', $job->salary, ['class' => 'form-control', 'rows' => '3']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('holiday', $job->holiday, ['class' => 'form-control', 'rows' => '3']) }}
                    ...
                    <tr>
                        ...
                        <td>
                            {{ Form::textarea('capacity', $job->capacity, ['class' => 'form-control', 'rows' => '5']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('benefit', $job->benefit, ['class' => 'form-control', 'rows' => '3']) }}
                ...
                <table class="job-entry-table">
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('choice_process', $job->choice_process, ['class' => 'form-control', 'rows' => '5']) }}
                      ...
                      <tr>
                        ...
                        <td>
                        	{{ Form::textarea('interview_address', $job->interview_address, ['class' => 'form-control', 'rows' => '3']) }}
                ...
                <table class="job-entry-table">
                    ...
                    <tr>
                        ...
                        <td>
							...
							<div id="div_sub_images">{{ $surpasses['sub_company']->html('preview') }}</div>
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::text('pic_department', $job->pic_department, ['class' => 'form-control input-text-l']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::text('pic_name', $job->pic_name, ['class' => 'form-control input-text-l']) }}
                    ...
                    <tr>
                        ...
                        <td>
                        	{{ Form::textarea('pic_comment', $job->pic_comment, ['class' => 'form-control', 'rows' => '5']) }}
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="radio-inline">
                              {{ Form::radio('notification_type', '1', ($job->notification_type == 1)) }} 企業情報で登録したメールアドレスに通知
                            </label>
                            <label class="radio-inline">
                              {{ Form::radio('notification_type', '2', ($job->notification_type == 2)) }} 下記に入力したメールアドレスに通知
                            </label><br />
                        	{{ Form::text('notification_email', $job->notification_email, ['class' => 'form-control input-text-l']) }}
                ...
                <table class="job-entry-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="radio-inline">
                              {{ Form::radio('displayed', '1', ($job->displayed == 1)) }} 掲載
                            </label>
                            <label class="radio-inline">
                              {{ Form::radio('displayed', '0', ($job->displayed == 0)) }} 非掲載
                            </label>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="radio-inline">
                              {{ Form::radio('application_ceiling_type_id', '0', ($job->application_ceiling == 0)) }} 制限なし
                            </label>
                            <label class="radio-inline">
                              {{ Form::radio('application_ceiling_type_id', '1', ($job->application_ceiling > 0)) }} 制限有り
                            </label>
                            
                            {{ Form::select('application_amount', ApplicationCeiling::application_amounts(), $job->application_ceiling, ['class' => 'form-control input-select-s']) }} 人まで
            ...
            {{ Form::hidden('recommended', $job->recommended) }}
            {{ Form::close() }}
